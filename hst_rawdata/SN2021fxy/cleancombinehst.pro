pro cleancombinehst, output, z, muvspectra, nuvspectra 
...
if n_muv gt 0 then readcol, muvspectra[1], wave_uv1_2,  flux_uv1_2,  fluxerr_uv1_2,  dq_uv1_2,  format=('F,F,F,I')

if n_muv gt 1 then readcol, muvspectra[2], wave_uv1_3,  flux_uv1_3,  fluxerr_uv1_3,  dq_uv1_3,  format=('F,F,F,I')

if n_muv gt 2 then readcol, muvspectra[3], wave_uv1_4,  flux_uv1_4,  fluxerr_uv1_4,  dq_uv1_4,  format=('F,F,F,I')

if n_muv gt 3 then readcol, muvspectra[4], wave_uv1_5,  flux_uv1_5,  fluxerr_uv1_5,  dq_uv1_5,  format=('F,F,F,I')


                   dqbits_uv1_1 =strarr(16,n_elements(dq_uv1_1))
if n_muv gt 0 then dqbits_uv1_2 =strarr(16,n_elements(dq_uv1_2))
if n_muv gt 1 then dqbits_uv1_3 =strarr(16,n_elements(dq_uv1_3))
if n_muv gt 2 then dqbits_uv1_4 =strarr(16,n_elements(dq_uv1_4))
if n_muv gt 3 then dqbits_uv1_5 =strarr(16,n_elements(dq_uv1_5))
...
if n_muv gt 0 then for n=0,n_elements(dq_uv1_2)-1  do dqbits_uv1_2[*,n]=binary(dq_uv1_2[n])
if n_muv gt 1 then for n=0,n_elements(dq_uv1_3)-1  do dqbits_uv1_3[*,n]=binary(dq_uv1_3[n])
if n_muv gt 2 then for n=0,n_elements(dq_uv1_4)-1  do dqbits_uv1_4[*,n]=binary(dq_uv1_4[n])
if n_muv gt 3 then for n=0,n_elements(dq_uv1_5)-1  do dqbits_uv1_5[*,n]=binary(dq_uv1_5[n])
...
cgplot,   wave_opt1_1[where(dqbits_opt1_1[11,*] ne '1' and dqbits_opt1_1[6,*] ne '1' )],   flux_opt1_1[[where(dqbits_opt1_1[11,*] ne '1' and dqbits_opt1_1[6,*] ne '1' )]], psym=14, color='blue', xrange=[wavestart-100.0,wavestop+100.0]
...
cgplot,   wave_uv1_1[where(dqbits_uv1_1[4,*] ne '1' and dqbits_uv1_1[6,*] ne '1' and dqbits_uv1_1[13,*] ne '1')],    flux_uv1_1[where(dqbits_uv1_1[4,*] ne '1' and dqbits_uv1_1[6,*] ne '1' and dqbits_uv1_1[13,*] ne '1')],   psym=16, color='green'
oplot, [wavestart,wavestart], [0,10^(-12.0)], psym=-5,color='black'
oplot, [wavestop,wavestop], [0,10^(-12.0)], psym=-5, color='black'
print, "change wavestart and wavestop if you want"

stop
;cgplot,   wave_uv1_1[where(dqbits_uv1_1[4,*] ne '1' and dqbits_uv1_1[6,*] ne '1' and dqbits_uv1_1[13,*] ne '1') and abs(flux_uv1_1-avgflux_uv1_1)<2*stdflux_uv1_1],    flux_uv1_1[where(dqbits_uv1_1[4,*] ne '1' and dqbits_uv1_1[6,*] ne '1' and dqbits_uv1_1[13,*] ne '1') and abs(flux_uv1_1-avgflux_uv1_1)<2*stdflux_uv1_1],   psym=16, color='green'
...
if n_muv gt 0 then uv2good=[where(dqbits_uv1_2[4,*] ne '1' and dqbits_uv1_2[6,*] ne '1' and dqbits_uv1_2[13,*] ne '1')]
if n_muv gt 1 then uv3good=[where(dqbits_uv1_3[4,*] ne '1' and dqbits_uv1_3[6,*] ne '1' and dqbits_uv1_3[13,*] ne '1')]
if n_muv gt 2 then uv4good=[where(dqbits_uv1_4[4,*] ne '1' and dqbits_uv1_4[6,*] ne '1' and dqbits_uv1_4[13,*] ne '1')]
if n_muv gt 3 then uv5good=[where(dqbits_uv1_5[4,*] ne '1' and dqbits_uv1_5[6,*] ne '1' and dqbits_uv1_5[13,*] ne '1')]
