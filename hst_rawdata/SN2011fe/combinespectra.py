...
flux3 = []
fileprogress = 0
#for the length of wavelength3, getting the combined flux #SN2022hrs_G430L_20220515_1
#using directory path because even though the code is in the same folder it doesnt register because ??? it used to work fine
combfiles = ['c:\\Users\\Evan\\Desktop\\Portfolio\\Code\\DrBProj\\SN2022hrs_G430L_20220515_1.dat','c:\\Users\\Evan\\Desktop\\Portfolio\\Code\\DrBProj\\SN2022hrs_G230L_20220515_1.dat']    #use g430 and g230, just a little overlap
  ...
  with open(x,'r') as f1:
   for line in f1:
    ...
    for i in range(len(wv3)):
      ...
      w3 = wv3[i]
      idx1, idx2 = None, None
     #checking if there is flux at the index of w3, if there is at both, average them, if there is one but not another, it just takes that flux
      try:
